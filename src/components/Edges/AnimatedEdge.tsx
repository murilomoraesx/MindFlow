...
export const AnimatedEdge = memo(({
  ...
  const pulseDuration =
    animationStyle === 'subtle' ? '2.6s' : animationStyle === 'tech' ? '1.45s' : edgeVariant === 'solid' ? '2.6s' : isFunnelConnection ? '1.8s' : '2.1s';
      ...
      return (
        <g className={[className, 'mf-edge-particle-group', 'mf-edge-particle-group-subtle'].filter(Boolean).join(' ')}>
          <rect x="-4.9" y="-1.7" width="9.8" height="3.4" rx="1.2" fill={particleColor} className="mf-edge-tech-packet mf-edge-subtle-packet" style={{ filter: `drop-shadow(0 0 7px ${particleColor}77)` }}>
            ...
            <animateMotion dur={particleDuration} rotate="auto" repeatCount="indefinite" path={edgePath} />
          </rect>
          ...
          <rect x="-6.4" y="-1.1" width="5.2" height="2.2" rx="0.8" fill={particleColor} className="mf-edge-subtle-trail" style={{ filter: `blur(0.6px)` }}>
            ...
            <animateMotion dur={particleDuration} begin="-0.45s" rotate="auto" repeatCount="indefinite" path={edgePath} />
          </rect>
        </g>
      );
    }
      ...
      return (
        <g className={[className, 'mf-edge-particle-group', 'mf-edge-particle-group-tech'].filter(Boolean).join(' ')}>
          ...
          >
            ...
            <animateMotion dur={particleDuration} begin="-0.55s" rotate="auto" repeatCount="indefinite" path={edgePath} />
          </rect>
          <rect
            x="-2.6"
            y="-0.95"
          ...
          >
            ...
            <animateMotion dur={particleDuration} begin="-0.95s" rotate="auto" repeatCount="indefinite" path={edgePath} />
          </rect>
        </g>
      );
    }
